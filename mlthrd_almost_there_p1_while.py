...
def write_response (json_file, start_index, debug = DEBUG):
    file_name = './save_jung_id/294594-307000/' + str(start_index) + '.json'
...
def calculate_level_from_range_two(thread_session):
    jungle_id_offset_ind = 299243
    for i in tqdm(range (299243, 307000)):
        if jungle_id_offset_ind > 307000: break
