...
phrasal_list_big = []
with open(os.path.join(BASE, "materials","phrasal_verbs.txt"), "r") as pv_doc:
    for pv in pv_doc:
        phrasal_list_big.append(pv[:-1])

#UPLOAD BASIC VOCABULARY	
basic_vocabulary = []
with open(os.path.join(BASE, "materials","CEFR","a1_vocab_processed.txt"), "r") as voc:
...
adjectives = []
with open(os.path.join(BASE,"materials","common_adj.txt"), "r") as common_adj:
    for word in common_adj.readlines():
        adjectives.append(word[:-1].lower())
        
common_uncountable = []
with open(os.path.join(BASE,"materials","common_unountable_manually_filtered.txt"), "r") as common_unctbl:
    for word in common_unctbl.readlines():
        common_uncountable.append(word[:-1].lower())

countries = []
with open(os.path.join(BASE,"materials","countries.txt"), "r") as cntr:
    for word in cntr.readlines():
        countries.append(word[:-1].lower())

names = []
with open(os.path.join(BASE,"materials","names.txt"), "r") as names_file:
...
if word_to_find:
    print (word_to_find)
A2 = []
with open(os.path.join(BASE,"materials","CEFR","a2_vocab_processed.txt"), "r") as voc:
    for word in voc.readlines():
        if word_to_find:
...
B1 = []
with open(os.path.join(BASE,"materials","CEFR","b1_vocab_processed.txt"), "r") as voc:
    for word in voc.readlines():
        if word_to_find:
            print (word)
            if word_to_find in word:
...
with open(os.path.join(BASE,"materials","CEFR","b2_vocab_processed.txt"), "r") as voc:
    for word in voc.readlines():
        if word_to_find:
            if word_to_find in word:
                print (word, 'B2')
...
with open(os.path.join(BASE,"materials","CEFR","c1_vocab_processed.txt"), "r") as voc:
    for word in voc.readlines():
        if word_to_find:
            if word_to_find in word:
                print (word, 'C')
...
c2 = []
#os.path.join(BASE,"materials","CEFR","c2_vocab_processed.txt")
with open(os.path.join(BASE,"materials","CEFR","c2_vocab_processed.txt"), "r") as voc:
    for word in voc.readlines():
        if word_to_find:
            if word_to_find in word:
                print (word, 'C')
